...
$('a').on( 'click', $.proxy(obj.doIt, $('a'))); ///vanilla javascript
///use $.proxy(obj.method, obj)1st is the method, 2nd arg to pass --> its going to refer to $.this, the object to target.
/// $.proxy - using obj method w/o creating anonymous function & passing 2ndArg

// $('a').on('click', function(e) {
// 	// this = anchor that was clicked
// 	obj.doIt.call(this); /// use $.call() to pass (this) on an anonymous function
...
$('a#test2').on('click',function(evt){
	...
	//console.log(this);
	//console.log(evt);
	obj.doIt.call(this, evt); ///$.call(thisArg, only variables)
